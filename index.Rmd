...
<small><small>Aquí encontrará datos con indicadores útiles en formato de tabla para 188 países del mundo, actualizados diariamente. 

Cada país tiene un triángulo negro que al hacer click sobre él se despliegan dos opciones: Confirmados y Fallecidos; los números entre paréntesis muestran los días que se tienen registrados para ese país y esa categoría. Seguidamente, puede presionar el triángulo de 'Confirmados' y/ó 'Fallecidos' y podrá ver la base de datos completa.</small></small>
